...
namespace Ticketing.UnitTests.ServicesTests
{
    public class OrderServiceTests
    {
        ...
        public static OrderService PrepareDataForSuccess()
        {
            ...
            mockPaymentRepository = new Mock<Repository<Payment>>(mockContext.Object);
            mockPaymentStatusRepository = new Mock<Repository<PaymentStatus>>(mockContext.Object);
            mockShoppingCartsRepository = new Mock<Repository<ShoppingCart>>(mockContext.Object);
